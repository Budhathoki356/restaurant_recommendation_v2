...
export class ProfileRestaurantComponent implements OnInit {
  ...
  countStar(star: any, id: any) {
    ...
    this.restaurantService.addRate(this.selectedValue, id).subscribe(result => {
      console.log(result)
    })
  }

  onReviewSubmit(id: any) {
    this.restaurantService.addReview(id, this.reviewForm.value.review).subscribe(result => {
